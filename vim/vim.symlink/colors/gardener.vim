...
"
"    Modified: Robbie McElrath <robbiemcelrath@gmail.com>
...
" Colors for the User Interface.
    ...
    exec "hi NonText        cterm=NONE   ctermfg=230   ctermbg=16"
    ...
    " Colors for autocomplete box
    exec "hi Pmenu          cterm=NONE   ctermfg=45    ctermbg=238"
    exec "hi PmenuSel       cterm=BOLD   ctermfg=255   ctermbg=242"

    " Colors for Syntax Highlighting.
    if exists("g:gardener_light_comments")
        exec "hi Comment        cterm=NONE   ctermfg=253   ctermbg=60"
    else
        exec "hi Comment        cterm=NONE   ctermfg=39   ctermbg=NONE"
    endif
    ...
    exec "hi Number         cterm=BOLD   ctermfg=203   ctermbg=NONE"
    ...
    exec "hi Statement      cterm=BOLD   ctermfg=214   ctermbg=NONE"

    exec "hi Define         cterm=BOLD   ctermfg=68    ctermbg=NONE"
    exec "hi Conditional    cterm=BOLD   ctermfg=214   ctermbg=NONE"

    exec "hi Repeat         cterm=BOLD   ctermfg=214   ctermbg=NONE"
    exec "hi Label          cterm=BOLD   ctermfg=214   ctermbg=NONE"
    exec "hi Operator       cterm=BOLD   ctermfg=173   ctermbg=NONE"
    exec "hi Keyword        cterm=BOLD   ctermfg=214   ctermbg=NONE"
    exec "hi Exception      cterm=BOLD   ctermfg=214   ctermbg=NONE"
    ...
    exec "hi Type           cterm=BOLD   ctermfg=35    ctermbg=NONE"
    exec "hi StorageClass   cterm=BOLD   ctermfg=35    ctermbg=NONE"
    ...
    exec "hi SpecialChar    cterm=BOLD   ctermfg=110   ctermbg=NONE"
